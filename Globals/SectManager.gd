...
# Creates a new sect, registers it, and returns its resource.
func create_sect(name: String, initial_resources: Dictionary = {}) -> SectResource:
...
# 2. Call `SectManager.create_sect("Sect Name")` to create a new sect.
